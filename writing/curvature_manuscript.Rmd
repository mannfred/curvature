...
-insert table with mean +/- 95%CI of sizes (mm) for all three species.
...
```{r table3}
library(here)
table3<-read.csv(here('data/Table_3_elapsed_days_per_stage.csv'), header=TRUE)
